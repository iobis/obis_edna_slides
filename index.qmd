...
5. [eDNA Data Management History](https://drive.google.com/file/d/1pe_M3dvybOFG9rqrXiG1YljeWWAdQ__8/view){target="_blank" rel="noopener noreferrer"} (Video recording)
6. [Mapping Molecular data to Darwin Core](index-map-edna-to-dwc.html)
7. Quality Control
    - eDNA Quality Control
    - [eDNA Quality Control tool](https://www.youtube.com/watch?v=e7HBAFf5NFg&feature=youtu.be){target="_blank" rel="noopener noreferrer"} (YouTube recording)
